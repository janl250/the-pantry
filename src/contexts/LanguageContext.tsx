...
const translations = {
  de: {
    ...
    'dishLibrary.sort.label': 'Sortieren nach',
    'dishLibrary.sort.ratingDesc': 'Bewertung (höchste zuerst)',
    'dishLibrary.sort.ratingAsc': 'Bewertung (niedrigste zuerst)',
    'dishLibrary.sort.nameAsc': 'Name (A-Z)',
    'dishLibrary.sort.nameDesc': 'Name (Z-A)',
    'dishLibrary.sort.timeAsc': 'Kochzeit (kürzeste zuerst)',
    'dishLibrary.sort.timeDesc': 'Kochzeit (längste zuerst)',
    'dishLibrary.sort.difficultyAsc': 'Schwierigkeit (einfach zuerst)',
    'dishLibrary.sort.difficultyDesc': 'Schwierigkeit (schwer zuerst)',
  ...
  en: {
    ...
    'dishLibrary.sort.label': 'Sort by',
    'dishLibrary.sort.ratingDesc': 'Rating (highest first)',
    'dishLibrary.sort.ratingAsc': 'Rating (lowest first)',
    'dishLibrary.sort.nameAsc': 'Name (A-Z)',
    'dishLibrary.sort.nameDesc': 'Name (Z-A)',
    'dishLibrary.sort.timeAsc': 'Cooking Time (shortest first)',
    'dishLibrary.sort.timeDesc': 'Cooking Time (longest first)',
    'dishLibrary.sort.difficultyAsc': 'Difficulty (easiest first)',
    'dishLibrary.sort.difficultyDesc': 'Difficulty (hardest first)',
    ...
    'weeklyCalendar.cleared': 'Week cleared successfully!',
    ...
    'addDish.ingredientPlaceholder': 'Type ingredient and press Enter',
